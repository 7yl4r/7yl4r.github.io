...
![everglades-features](everglades-features.png)

These appear to be seafloor features, although some image mosaicking artifacts are also in the region.
The bathymetry layer is too coarse to confirm any physical shapes.

![everglades-features-bathy](everglades-features-bathy.png)

A view from along the NorthWest edge of the "dense seagrass" area shows these patches as very similar to the seagrass.

![everglades-features-context](everglades-features-context.png)
...
![results-w-bathy-v2](results-w-bathy-v2.png)

Some features in the northwest from the bathymetry layer seem over-pronounced.
Further refinement of the ground truth data from regional experts is needed.
