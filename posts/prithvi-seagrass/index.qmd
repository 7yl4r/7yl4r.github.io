...
Initial starting point is [this Prithvi-EO notebook](https://github.com/Prithvi-EO/notebooks/prithvi_v2_eo_300_tl_unet_multitemporal_crop.ipynb).
...
A GEE script to create this image using three composite (median) images from for images from years 2023-2025 was created [here](https://code.earthengine.google.com/?scriptPath=users%2Ftylarmurray%2Fscratch%3Aprithvi_planet_median_creation).
